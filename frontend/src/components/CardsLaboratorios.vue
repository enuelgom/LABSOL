                                ...
                                <v-col cols="12" md="4" lg="3" sm="6"  class="my-2" v-for="item of DatosIntel" :key="item.nombre">
                                    <v-hover v-slot:default="{ hover }" open-delay="200">
                                        <v-card style="width: 150%" height="100%" :elevation="hover ? 16 : 2">
                                            ...
                                            <v-card-text class="mt-2 font-weight-bold">Total de proyectos: {{ item.count }}</v-card-text>
                                            <v-card-actions>
                                ...
                                <v-col cols="12" md="4" lg="3" sm="6"  v-for="item of DatosLabsol" :key="item.nombre" class="my-2">
                                    <v-hover v-slot:default="{ hover }" open-delay="200">
                                        <v-card style="width: 150%" height="100%" :elevation="hover ? 16 : 2">
                                            ...
                                            <v-card-text class="mt-2 font-weight-bold">Total de proyectos: {{ item.count }}</v-card-text>
                                            <v-card-actions>
                                                <v-btn text color="blue-grey darken-3" :to="{ name: 'ProyectosLaboratorios', params:{nameLab:item.nombre} }" v-if="usuarioLogeado.tipUsuario === '0'" >Ver proyectos</v-btn> 
                                        <v-btn dark block color="blue-grey darken-3" :to="{ name: 'ProyectosLaboratorios', params:{nameLab:item.nombre} }" v-else-if="usuarioLogeado.tipUsuario === '1' && item['nombre'] === usuarioLogeado.nombre">Mis proyectos</v-btn>
                                                <v-btn text color="blue-grey darken-3" :to="{ name: 'ProyectosLaboratorios', params:{nameLab:item.nombre} }" v-else-if="usuarioLogeado.tipUsuario === '1'">Ver proyectos</v-btn>
                                                <v-btn text color="blue-grey darken-3" :to="{ name: 'ProyectosLaboratorios', params:{nameLab:item.nombre} }" v-else-if="usuarioLogeado.tipUsuario === '2'">Ver catalogo</v-btn>
                                                <v-btn text color="blue-grey darken-3" :to="{ name: 'ProyectosLaboratorios', params:{nameLab:item.nombre} }" v-else>Ver catalogo</v-btn>
                                            </v-card-actions>
                                        </v-card>
                                    </v-hover>
                                </v-col>
